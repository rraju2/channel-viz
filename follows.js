(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'ygNbvTzyMzsRR59tNM99881rgmOqlL3Kwk5SdqRi4nzd1ARv', // Unique master Xively API key to be used as a default
		defaultFeeds	= [2040066393], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'WBS', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
